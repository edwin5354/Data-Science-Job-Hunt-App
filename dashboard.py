...
path = r"C:\Users\Edwin\Python\bootcamp\Projects\Project_3\csv\skill.csv"
skill_df = pd.read_csv(path)

music = r"C:\Users\Edwin\Python\bootcamp\Projects\Project_3\Rachmaninoff Elegie Op. 3 No. 1.mp3"
st.write('Rachmaninoff Elegie Op. 3 No. 1')
st.audio(music, format="audio/mp3", loop=True)

st.image(r'C:\Users\Edwin\Python\bootcamp\Projects\Project_3\images\bg_img.png')
...
st.image(r"C:\Users\Edwin\Python\bootcamp\Projects\Project_3\images\data_visualisation\skills.png")
st.markdown(
"""    
...
st.image(r'C:\Users\Edwin\Python\bootcamp\Projects\Project_3\images\data_visualisation\association_matrix.png')
st.write(
...
st.image(r"C:\Users\Edwin\Python\bootcamp\Projects\Project_3\images\ML\elbow.png")
...
st.image(r'C:\Users\Edwin\Python\bootcamp\Projects\Project_3\images\ML\dendrogram.png')
...
st.image(r'C:\Users\Edwin\Python\bootcamp\Projects\Project_3\images\ML\cluster.png')
...
st.image(r"C:\Users\Edwin\Python\bootcamp\Projects\Project_3\images\ML\tree.png")
...
st.image(r"C:\Users\Edwin\Python\bootcamp\Projects\Project_3\images\ML\feature_importance.png")
st.markdown(
"""
...
pickle_path = r"C:\Users\Edwin\Python\bootcamp\Projects\Project_3\decision_tree_model.pkl"
...
merged_label_df = pd.read_csv(r"C:\Users\Edwin\Python\bootcamp\Projects\Project_3\csv\cluster_merged.csv", index_col= 0)
